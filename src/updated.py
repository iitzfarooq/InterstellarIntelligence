...
solar_intensity = variables[
    "solar_intensity"
]  # dependent_variables.get("solar_intensity") / 100
...
def get_terrain_color(noise_value, rainfall, plant_density):
    ...
    if plant_density < 50:
        ...
        plant_factor = max(
            0, (200 - plant_density) / 100
        )  # max(0, 1 - (plant_density - 100) / 100)  # Gradually turns brown again
    else:
    ...
    if rainfall < 80000:
        ...
        rain_factor = max(
            0, 1 - (rainfall - 90000) / 10000
        )  # Gradually fades out above 90000
    else:
        rain_factor = (rainfall - 80000) / (
            90000 - 80000
        )  # Most blue in 80000-90000 range
